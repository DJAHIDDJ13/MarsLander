...
from MarsLanderSim import MarsLanderEnv
...
# 5 thrust values and 13 simplified angle values (step of 15)
n_actions = 5 * 13
...
for i_episode in range(num_episodes):
    ...
    if i_episode % 1 == 0:
        INIT_POSITION[0] = random.randint(200, MarsLanderSim.WORLD_WIDTH-200)
    #steps_done = 0
    for t in count():
        # Debug message
